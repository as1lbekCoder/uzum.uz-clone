...
const BagSvg: FC<IconsProps> = ({ className }) => {
    return (
        <svg data-v-b4904ad2="" width="24" height="24" viewBox="0 0 24 24" fill="black" xmlns="http://www.w3.org/2000/svg" className={className}>
